...
(function() {
    ...
    TigerController.controller('luishuiCtrl',function($scope,$cookieStore,globalService,$stateParams) {
        ...
        $scope.luishuizhifu = function(){
            ...
            console.log(param);
            globalService.commonPost(TigerConfig.api.updateApply,param).then(function(result){
                if(result.code == '0'){
                    console.log(result);
