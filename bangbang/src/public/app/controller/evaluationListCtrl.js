...
(function() {
    ...
    TigerController.controller('evaluationListCtrl',function($scope,$cookieStore,$stateParams,$ionicViewSwitcher,$state,$ionicActionSheet,$timeout,globalService) {
        ...
        $scope.request = {
            findComment: function (goodsId,currentPage) {
                ...
                globalService.commonPost(TigerConfig.api.findComment,param).then(function (result) {
