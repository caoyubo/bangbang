...
(function() {
  ...
  TigerController.controller('storeCtrl',function($scope,$stateParams,$cookieStore,$ionicViewSwitcher,$state,globalService,publicFunction) {
    ...
    $scope.request = {
      collection : function(param){
        globalService.commonPost(TigerConfig.api.collection,param).then(function(result){
          console.log(result);
          if(result.code == 0){
            console.log(result);
            alert("收藏店铺成功!");
      ...
      findStoreInfo : function(){
        globalService.commonGet(TigerConfig.api.findStoreInfo+"?shopId="+$scope.shopid).then(function(result){
          if(result.code == 0){
            console.log("店铺详细信息::");
            console.log(result);
      ...
      goodsByShopId : function(){
        globalService.commonGet(TigerConfig.api.goodsByShopId+"?shopid="+$scope.shopid).then(function(result){
          if(result.code == 0){
      ...
      fans_select : function(){
        globalService.commonGet(TigerConfig.api.fans_select+"?shopId="+$scope.shopid+"&userId="+$scope.user.uid).then(function(result){
          console.log("粉丝关系::");
          console.log(result);
          if(result.code == 0){
      ...
      fans_count : function(){
        globalService.commonGet(TigerConfig.api.fans_count+"?shopId="+$scope.shopid).then(function(result){
          console.log("店铺粉丝数::");
          console.log(result);
          if(result.code == 0){
      ...
      fans_create : function(){
        ...
        globalService.commonPost(TigerConfig.api.fans_create,param).then(function(result){
          console.log("关注店铺::");
          console.log(result);
          if(result.code == 0){
            alert(result.mes);
      ...
      fans_delete : function(){
        globalService.commonGet(TigerConfig.api.fans_delete+"?shopId="+$scope.shopid+"&userId="+$scope.user.uid).then(function(result){
          console.log("取消关注店铺::");
          console.log(result);
          if(result.code == 0){
            $scope.request.fans_select();
