...
(function() {
  ...
  TigerController.controller('upgradeCtrl',function($scope,$cookieStore,$stateParams,globalService) {
    ...
    $scope.agree = function(){
      ...
      console.log("申请升级::");
      console.log(param);
      globalService.commonPost(TigerConfig.api.apply,param).then(function(result){
        console.log("申请升级信息::");
        console.log(result);
        if(result != undefined){
