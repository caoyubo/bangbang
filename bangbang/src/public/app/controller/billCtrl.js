...
(function() {
    ...
    TigerController.controller('billCtrl',function($scope,$cookieStore,$ionicViewSwitcher,$state,$ionicPopup,$ionicActionSheet,$ionicHistory,globalService,publicFunction) {
        ...
        $scope.request = {
            diamondGetDetail : function(){
                globalService.commonPost(TigerConfig.api.diamondGetDetail,$scope.AccountQueryDealLogCustCodeRequest).then(function(result){
