...
(function() {
    ...
    TigerController.controller('widthdrawCtrl',function($scope,$cookieStore,$ionicViewSwitcher,$state,$ionicPopup,$ionicActionSheet,$ionicHistory,globalService) {
        ...
        var withdraw = $scope.withdraw = {
            ...
            embodyDiamondWithdraw:function(){ //ti
                ...
                console.log(param);
                globalService.commonPost(TigerConfig.api.diamondWithdraw,param).then(function(result){
                    console.log(result);
                    if(result.code=='0'){
                        $ionicPopup.confirm({
                            title: result.mes,
