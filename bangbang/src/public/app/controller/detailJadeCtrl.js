...
(function() {
    ...
    TigerController.controller('detailJadeCtrl', function ($scope, $cookieStore, $stateParams, $ionicViewSwitcher, $ionicHistory, $state, $ionicModal, $ionicBackdrop, $ionicActionSheet, globalService, publicFunction) {
        ...
        $scope.request = {
            getGoodsDetail: function () {
                globalService.commonGet(TigerConfig.api.gift_findById + "?id=" + $scope.id).then(function (result) {
                    if (result.code == 0) {
                        console.log("商品详情信息::");
                        console.log(result);
