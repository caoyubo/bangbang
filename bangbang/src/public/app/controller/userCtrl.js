...
(function() {
  ...
  TigerController.controller('userCtrl',function($scope,$cookieStore,$ionicViewSwitcher,$state,globalService,publicFunction) {
  ...
  $scope.request = {
    ...
    getLevel : function(){
      globalService.commonGet(TigerConfig.api.getUserInfo+"?uid="+$scope.user.uid).then(function(result){
  ...
  $scope.myHref = function(state){
    $ionicViewSwitcher.nextDirection('forward');
    $state.go('order', {'state': state});
  }
})
