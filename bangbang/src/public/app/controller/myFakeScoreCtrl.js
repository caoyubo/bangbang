...
(function() {
  ...
  TigerController.controller('myFakeScoreCtrl',function($scope,$cookieStore,globalService,publicFunction) {
    ...
    $scope.request = {
      ...
      jadeGetDetail : function(){
        globalService.commonPost(TigerConfig.api.jadeGetDetail,{ownerid :$scope.user.uid}).then(function(result){
