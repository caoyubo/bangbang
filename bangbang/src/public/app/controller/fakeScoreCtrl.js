...
(function() {
  ...
  TigerController.controller('fakeScoreCtrl',function($scope,$ionicModal,$ionicViewSwitcher,$cookieStore,$timeout,$state,globalService,publicFunction) {
    ...
    $scope.request = {
      findGoods : function(currentPage){
        ...
        globalService.commonPost(TigerConfig.api.gift_findGoods,param).then(function(result){
          console.log("查询翡翠商品::");
          console.log(result);
          if(result.code == "0"){
