...
(function() {
    ...
    TigerController.controller('evaluationCtrl',function($scope,$cookieStore,$stateParams,$ionicViewSwitcher,$state,$ionicActionSheet,$ionicHistory,$timeout,globalService) {
        ...
        $scope.request = {
            orderDetail : function(){
                globalService.commonGet(TigerConfig.api.orderDetail+"?id="+$scope.orderId).then(function(result){
                    console.log("订单详情::");
                    console.log(result);
                    if(result.code == 0){
            ...
            createComment : function(param){
                globalService.commonPost(TigerConfig.api.goodsComment,param).then(function(result){
                    console.log("评论::");
                    console.log(result);
                    if(result.code == 0){
