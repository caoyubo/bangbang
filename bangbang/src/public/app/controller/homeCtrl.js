...
(function() {
    "use strict";
    TigerController.controller('homeCtrl',function($scope,$ionicModal,$ionicViewSwitcher,$cookieStore,$timeout,$state,globalService,publicFunction,tigerLoading) {
        ...
        $scope.request = {
            ...
            findResourceByColId : function(colId){
                globalService.commonGet(TigerConfig.api.findResourceByColId+"?colId="+colId).then(function(result){
                    if(colId == 1){
                        console.log("首页轮番图::");
                        console.log(result);
                        if(result.code == "0"){
