...
var BCrypto = require('../common/bcrypto');
 ...
 * 检测用户是否存在
 */
exports.checkUser = function (bfw , req , res) {
 ...
 * 检测手机号是否存在
 */
exports.checkPhone = function (bfw , req , res) {
 ...
 * 验证码
 */
exports.verify = function (bfw , req , res) {
  console.log('***************verify***************');
  var timestamp = parseInt(new Date().getTime() / 1000) + '';
 ...
 * 注册接口
 */
exports.register = function (bfw , req , res) {
  ...
  var dataJson = {
    username: username, account: account, passwd: passwd, repasswd: repasswd,
...
exports.reg = function (bfw , req , res) {
  console.log('***************reg***************');
  var timestamp = parseInt(new Date().getTime() / 1000) + '';
  var op = 'reg';
  var content = getContent(op, timestamp);
...
exports.reg1 = function (bfw , req , res) {
  console.log('***************reg***************');
  var timestamp = parseInt(new Date().getTime() / 1000) + '';
  var op = 'reg';
  var content = getContent(op, timestamp);
...
exports.wxRegister = function (bfw , req , res) {
 ...
 * 登陆接口
 */
exports.login = function (bfw , req , res) {
  console.log('***************login***************');
  var timestamp = parseInt(new Date().getTime() / 1000) + '';
  var op = 'login';
  var content = getContent(op, timestamp);
 ...
 * 用户登出
 */
exports.logout = function (bfw , req , res) {
  console.log('***************logout***************');
 ...
 * 从session里面获取用户信息
 */
exports.getUserFromSession = function (bfw , req , res) {
 ...
 * 修改密码验证码
 */
exports.modifyCode = function (bfw , req , res) {
 ...
 * 修改密码
 */
exports.modify = function (bfw , req , res) {
  console.log('***************modify***************');
  var timestamp = parseInt(new Date().getTime() / 1000) + '';
  var op = 'modify_pw';
  var content = getContent(op, timestamp);
 ...
 * 申请
 */
exports.apply = function (bfw , req , res) {
  console.log('***************apply***************');
  var data = req.body;
 ...
 * 更新申请
 */
exports.updateApply = function (bfw , req , res) {
 ...
 * 获取当前等级以及可以申请的等级和金额
 */
exports.findLevelByUid = function (bfw , req , res) {
 ...
 * 根据uid获取升级状态
 */
exports.getStatusByUid = function (bfw , req , res) {
 ...
 * 根据uid获取升级状态
 */
exports.getUserByUid = function (bfw , req , res) {
...
exports.getUserByParent = function (bfw , req , res) {
...
/*exports.sendCode = function(bfw , req , res){
 console.log('***************getUserByUid***************');
 ...
 exports.verifyCode = function(bfw , req , res){
 console.log('***************getUserByUid***************');
