...
module.exports = {
	...
	api_address_list: {
		...
		haoyi_goods: {
			...
			api: {
				...
				goodsList           : 'goods/find/my/proxy',                     //代理商品
				unBindShop          : 'goods/invite/remove/{{uid}}',            //解绑
				inviteVerify        : 'goods/invite/verify/{{id}}/{{state}}'    //回应邀请
		...
		haoyi_jade: {
			...
			api: {
				...
				getDetail           :'points/autohistorypage'                               //获取翡翠积分的交易明细
			}
		},
		haoyi_diamond:{
			//host: 'points.api.haoyi',
		...
		haoyi_usercenter:{
			...
			api :{
				...
				col_delete              :'collection/delete/id/{{id}}',                          //根据id删除
		...
		haoyi_shop: {
			...
			api: {
				...
				store_add               : 'shop/add', //商店增加

				hasShop           :'shop/find/uid/shopinfo/{{uid}}',                     //是否有开店
				shopInfo          : 'shop/find/user/default/{{uid}}',                     // 开店的信息
			}
		},
		...
		haoyi_order:{
			...
			api: {
				...
				listPage                :'order/list/page'                              //订单列表(新)
			}
		},
		...
		haoyi_integration:{
			...
			api: {
				...
				getPayUrl               :'account/bill/getPayUrl'                       //获取支付的url
			}
		},
		 ...
		 */
		file : {
			host  : 'http://file.api.haoyi',
			port : '36601',
			api : {
				upload : 'file/mall/file',		//文件上传
			}
		},

	},

	callbackurl:'http://172.16.110.163:42000/order/paycallback',
	...
	app_host_params:{
		//host:"http://appapi.hy.com",  //cookie 线上域名
		host:"http://haoyi.yn.com:42000"//cookie 本地域名
	},
	cookies_params:{
		domain:".yn.com",
		//domain:'.hy.com',
